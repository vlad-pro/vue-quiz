...
<script>
// lodash by convention is imported via _
...
export default {
  ...
  watch:{
    ...
    // We are making an object(above) instead of a function in this
    // currentQuestion(){
    //   this.selectedIndex = null
    //   this.shuffleAnswers()
    // }
  ...
  methods: {
    ...
    answerClass(index){
      ...
      return answerClass
          ...
          // or use this in the template instead of a answerClass.
          // !answered && selectedIndex === index ? 'selected' :
          // answered && correctIndex === index ? 'correct':
          // answered && selectedIndex === index && correctIndex !== index ? 'incorrect': ''
    }
  },
  // mounted can work instead of making a currentQuestion an object
  // mounted(){
  //   this.shuffleAnswers()
  // }
}
